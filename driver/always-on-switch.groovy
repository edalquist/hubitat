...
metadata {
        // From: https://community.smartthings.com/t/disable-control-portion-of-outlet-controller/88649/5
    definition(name: "SmartPower Outlet - Always On", namespace: "edalquist", author: "Eric Dalquist", ocfDeviceType: "oic.d.smartplug") {
        capability "Actuator"
        capability "Switch"
...
def off() {
    // modified to make sure outlet always stays on.
    zigbee.on()
}
